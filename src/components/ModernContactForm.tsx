...
export default function ModernContactForm({ 
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      >
        <h2 className="heading-2 mb-4">{title || t('contact.title')}</h2>
        <p className="body-large">{description || t('contact.description')}</p>
      </motion.div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <textarea
                ...
                onChange={handleInputChange}
                rows={6}
                className={`input pl-10 resize-none ${errors.message ? 'border-red-500' : ''}`}
          ...
          <AnimatePresence>
            {submitStatus === 'success' && (
              ...
              >
                ...
                <div>
                  <h4 className="font-medium text-green-900">{t('contact.success')}</h4>
            ...
            {submitStatus === 'error' && (
              ...
              >
                ...
                <div>
                  <h4 className="font-medium text-red-900">{t('contact.error')}</h4>
