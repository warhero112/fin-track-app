...
export default function Footer() {
  ...
  const footerLinks = {
    ...
    services: [
      ...
      { name: 'Buying Services', href: '/buying' },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-300 mb-6 max-w-md">
                Your trusted partner for finding the perfect home in Japan. 
                We specialize in helping foreigners navigate the Japanese real estate market with confidence.
              </p>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-300">info@rentora.jp</span>
                </div>
                <div className="flex items-center space-x-3">
                  <MapPin className="w-5 h-5 text-primary-400" />
                  <span className="text-gray-300">1-2-3 Shibuya, Tokyo</span>
                </div>
              </div>
            </div>
